...
f();});opts.cssAfter={};opts.animIn={left:0};opts.animOut={left:0};};})(jQuery);(function($){$.extend($.fn,{delayedObserver:function(callback,delay,options){return this.each(function(){var el=$(this);var op=op||{};el.data('oldval',el.val()).data('delay',delay||0.5).data('condition',op.condition||function(){return($(this).data('oldval')==$(this).val());}).data('callback',callback)
...
return trans||str;};if(arguments.length<2&&arguments[0].length==2){return $._i18n.language=arguments[0];}
